...
var update = __webpack_require__(8)("717fcd61", content, false);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_layouts_vue__ = __webpack_require__(29);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__menus__ = __webpack_require__(30);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(8)("81b2b38a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-452ad334\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./menus.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-452ad334\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./menus.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	created() {
		Object(__WEBPACK_IMPORTED_MODULE_0__api_api__["d" /* getTodoList */])({}).then(res => {
  ...
  return _c("div", { staticClass: "page" }, [
    ...
    _c("div", { staticClass: "page_content" }, [
      _c(
        ...
        [
          _vm._l(_vm.items, function(item) {
            return _c("li", { staticClass: "todo_list_item" }, [
              _c("input", { attrs: { type: "checkbox" } }),
              _c("span", [_vm._v(_vm._s(item.text))])
            ])
          }),
          _vm._v(" "),
          _c("li", { staticClass: "todo_list_item todo_add" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
...
/* harmony default export */ __webpack_exports__["a"] = ({
	start() {
		...
		mock.onPost('/todo/addRecord').reply(config => {
			...
			__WEBPACK_IMPORTED_MODULE_3__data_todoList_js__["a" /* Todos */].some((t, index) => {
				if (t.id === id) {
					t.record.push({
						text: text,
						checked: false
